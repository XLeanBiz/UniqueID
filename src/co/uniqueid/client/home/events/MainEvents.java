...
public class MainEvents extends VerticalPanel {
	...
	private static VerticalPanel listGroups() {
		...
		hp.add(vpEvent1);
		GetMainEvents.getFromID("CustDevDay_1332642931554",
				"San Francisco - April 14th", vpEvent1);

		VerticalPanel vpEvent4 = new VerticalPanel();
		hp.add(vpEvent4);
		GetMainEvents.getFromID("LeanStartupMachine_1333817778070",
				"San Diego - April 20th", vpEvent4);

		VerticalPanel vpEvent5 = new VerticalPanel();
		hp.add(vpEvent5);
		GetMainEvents.getFromID("HackersAndFounders_1334342737882",
				"San Diego", vpEvent5);
